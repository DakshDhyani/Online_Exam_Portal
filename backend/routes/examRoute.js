...
// get all exams
router.post("/get-all-exams", auth, async (req, res) => {
  try {
...
// get exam by id
router.post("/get-exam-by-id", auth, async (req, res) => {
  try {
...
// delete exam by id
router.post("/delete-exam-by-id", auth, async (req, res) => {
  try {
...
router.post("/add-question-to-exam", auth, async (req, res) => {
  try {
...
router.post("/edit-question-in-exam", auth, async (req, res) => {
  try {
...
router.post("/delete-question-in-exam", auth, async (req, res) => {
     try {
